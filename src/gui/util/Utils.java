...
public class Utils {
	...
	public static <T> void formatarTableColumnData(TableColumn<T, Date> tableColumn, String formato) {
	...
	public static <T> void formatarTableColumnDouble(TableColumn<T, Double> tableColumn, int decimais) {
		tableColumn.setCellFactory(column -> {
			TableCell<T, Double> cell = new TableCell<T, Double>() {
				...
				protected void updateItem(Double item, boolean empty) {
					...
					if (empty) {
						...
						setText(String.format("%." + decimais + "f", item));
					}
				}
			};
			return cell;
